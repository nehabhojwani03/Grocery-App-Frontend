...
//       emoji: '🛒',
//       title: 'Customer',
//       desc: 'Shop & order groceries',
//     },
//     {
//       id: 'driver',
//       emoji: '🚗',
//       title: 'Delivery Rider',
//       desc: 'Deliver & earn money',
//     },
//   ];
...
//     // ✅ Pass role + driverFields as separate argument to authService.signup
//     // authService.signup(name, email, password, phone, role, fcmToken, driverFields)
//     const result = await dispatch(signupUser({
//       name,
//       email,
//       password,
//       phone,
//       role: selectedRole,           // ← 'user' or 'driver'
//       fcmToken,
//       // Driver fields bundled separately — authService picks them up
//       ...(selectedRole === 'driver' && {
//         vehicleType,
//         vehicleNumber,
//         licenseNumber,
...
//       ? 'Driver account created! You can start accepting deliveries after going online.'
//       : 'Account created!\n\nCheck your notifications for a special welcome offer!';
 
//     Alert.alert(
//       selectedRole === 'driver' ? 'Welcome, Rider! 🚗' : 'Welcome! 🎉',
//       successMsg,
//       [{ text: "Let's Go!" }]
//     );
...
//   },
//   roleCardSelected: {
//     borderColor: '#4CAF50', backgroundColor: '#f0fdf4',
//   },
...
const SignupScreen = ({ navigation }) => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      const homeScreen = ROLE_HOME_SCREEN[role] ?? 'Home';
